...
public class BubbleSortTest {
    ...
    static BubbleSorter bubbleSorter;
    static int[] arrayToSortTest;
    static int[] sortedArrayTest;

    @BeforeAll
    static void setBubbleSorter() {
    ...
    @Test
    @DisplayName("Testing the bubble sort algorithm by using the built-in Java sorter with the same input")
    public void checkBubbleSort() {
        Assertions.assertEquals(Arrays.toString(sortedArrayTest), Arrays.toString(bubbleSorter.sortArray(arrayToSortTest)));
    }
}
